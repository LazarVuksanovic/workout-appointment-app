...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen items-left p-24">
      ...
      <div className="flex flex-col  border-4 border-cyan-400 border-dashed gap-8 rounded-xl p-10 grow-0">
        <div className='flex justify-left mx-4 px-4 pb-2 border-b-2 border-black'>
        ...
        {appointments.map((a:any) => {
          return (
            <div className='flex justify-between items-center m-4 p-4 border-2 rounded-lg' key={a.id}>
              ...
              <button className="btn bg-red-400" id={a.id} onClick={() => handleCancel(a.id)}>Otkazi</button>
          </div>
          )
        })}
      </div>
